...
export const metadata = {
  ...
  description: 'A responsive News and Payout Dashboard built with Next.js, featuring article analytics, admin payout management, filters, export options, and more.',
};
